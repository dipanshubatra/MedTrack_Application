...
export const ROUTES = [
  ...
  { page: "procurement-timeline", slugs: ["procurement-timeline", "procurement-lifecycle"], component: ProcurementLifecycleTimeline, access: HOSPITAL_ONLY, param: "requestId" },
