...
export const ROUTES = [
  ...
  { page: "cardiovascular-hemodynamics", slugs: ["cardiovascular-hemodynamics", "hemodynamics", "advanced-circulatory-support"], component: CardiovascularHemodynamicsHub, access: AUTHENTICATED },
