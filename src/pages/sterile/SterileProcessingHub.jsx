      ...
      <main className="px-6 py-6">
        {tab === "trays" && (
          <div className="space-y-6">
            ...
            <section className="overflow-hidden rounded-2xl border border-slate-800">
              ...
              {filteredTrays.length === 0 && <EmptyState message="No trays match the current search and filter." />}
            </section>
          </div>
        )}
        ...
        {tab === "loads" && (
          <div className="space-y-6">
            ...
            <section className="space-y-3">
              ...
              {filteredLoads.length === 0 && <EmptyState message="No loads match the current search and filter." />}
            </section>
          </div>
        )}
        ...
        {tab === "decon" && (
          <div className="space-y-6">
            ...
            {filteredWashers.length === 0 && <EmptyState message="No washer-disinfectors match the search." />}
          </div>
        )}
      </main>
